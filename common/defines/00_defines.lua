...
NCountry = {
	...
	BASE_MOBILIZATION_SPEED = 0.05,					-- Base speed of manpower mobilization  #in 1/1000 of 1 %
...
NProduction = {
	...
	LICENSE_EQUIPMENT_BASE_SPEED = 0.0,				-- base MIC speed modifier for licensed equipment
	...
	LICENSE_EQUIPMENT_SPEED_NOT_FACTION = 0.0,		-- MIC speed modifier for licensed equipment for not being in faction
	LICENSE_EQUIPMENT_UPGRADE_XP_FACTOR = 2.0,			-- XP cost for upgrading licensed equipment
	LICENSE_EQUIPMENT_SPEED_NO_LICENSE = 0.0,			-- Penalty for producing non licensed equipment
...
NBuildings = {
	...
	MAX_BUILDING_LEVELS = 56,			-- Max levels a building can have.
	...
	INFRASTRUCTURE_RESOURCE_BONUS = 0.6, -- multiplicative resource bonus for each level of (non damaged) infrastructure
...
NMilitary = {
	...
	MAX_ARMY_EXPERIENCE = 99999,			--Max army experience a country can store
	MAX_NAVY_EXPERIENCE = 99999,			--Max navy experience a country can store
	MAX_AIR_EXPERIENCE = 99999,				--Max air experience a country can store
	...
	LAND_AIR_COMBAT_MAX_PLANES_PER_ENEMY_WIDTH = 6, -- how many CAS/TAC can enter a combat depending on enemy width there
	...
	MAX_NUM_TRAITS = 7,						   -- cant have more, -1 to disable
	ENEMY_AIR_SUPERIORITY_IMPACT = 0.0,          -- effect on defense due to enemy air superiorty
	ENEMY_AIR_SUPERIORITY_DEFENSE = 0.0,	       -- more AA attack will approach this amount of help (diminishing returns)
